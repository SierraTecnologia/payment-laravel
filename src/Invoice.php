...
class Invoice
{
    ...
    /**
     * The SierraTecnologia invoice instance.
     *
     * @var \SierraTecnologia\Invoice
     */
    protected $invoice;
    ...
    /**
     * Get the SierraTecnologia invoice instance.
     *
     * @return \SierraTecnologia\Invoice
     */
    public function asSierraTecnologiaInvoice()
    {
        return $this->invoice;
    }
