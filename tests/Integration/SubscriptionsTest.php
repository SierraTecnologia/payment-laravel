...
class SubscriptionsTest extends IntegrationTestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        static::$otherPlanId = static::$sierratecnologiaPrefix.'monthly-10-'.Str::random(10);
    ...
    public static function tearDownAfterClass()
    {
        ...
        static::deleteSierraTecnologiaResource(new Plan(static::$otherPlanId));
        static::deleteSierraTecnologiaResource(new Plan(static::$premiumPlanId));
        static::deleteSierraTecnologiaResource(new Product(static::$productId));
        static::deleteSierraTecnologiaResource(new Coupon(static::$couponId));
    }
    ...
    public function test_subscriptions_can_be_created()
    {
        ...
        $this->assertNotNull($user->subscription('main')->sierratecnologia_id);
        ...
        $this->assertEquals(static::$otherPlanId, $subscription->sierratecnologia_plan);
    ...
    public function test_creating_subscription_fails_when_card_is_declined()
    {
        ...
        try {
            ...
            $this->assertEmpty($user->asSierraTecnologiaCustomer()->subscriptions->data);
        }
    }
    ...
    public function test_plan_swap_succeeds_even_if_payment_fails()
    {
        ...
        $this->assertEquals(static::$premiumPlanId, $subscription->sierratecnologia_plan);
    }
